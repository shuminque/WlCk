...
public class DepositoryRecordController {
    ...
    public ResponseEntity<List<CategoryOutboundDTO>> getCategoryOutbounds(@PathVariable String year, @PathVariable String month, @PathVariable Integer depositoryId) {
